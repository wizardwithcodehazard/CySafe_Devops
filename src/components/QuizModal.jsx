...
export default function QuizModal({ module, close, isDark, addXp }) {
        ...
        <div className="space-y-4">
          {module.questions[qIndex].options.map((opt, i) => (
            <button
              ...
              disabled={!!feedback}
              className={`w-full p-5 rounded-2xl text-left font-bold text-sm border-2 transition-all duration-200 transform ${
                feedback 
